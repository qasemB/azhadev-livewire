    ...
    <div class="row my-4">
      <div id="articleRight" class="col-12 col-md-8 col-xl-9">
        <div class="p-2 bg-light rounded">
          <h1 class="text-center font_2 py-2">عنوان مقاله{{$articleId}}</h1>
          <div class="image text-center">
            <img src="/assets/images/articles/article1.png" alt="توضیح تصویر">
          </div>
          <div class="p-2 text_container">
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقالهتوضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقالهتوضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <img src="/assets/images/banner2.jpg" alt="توضیح تصویر">
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقالهتوضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
            <p>توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله توضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقالهتوضیحات کامل در مورد این مقاله و توضیحات کامل در مورد این مقاله</p>
      ...
      <div id="articleLeft" class="col-12 col-md-4 col-xl-3 mt-3 mt-md-0">
        <div class="row bg-light px1 py-5 text-center justify-content-center d-flex rounded w-100 m-auto">
          <div class="image rounded-circle overflow-hidden h_10 w_10 text-center justify-content-center">
            <img class="max_w_100 m-auto" src="/assets/images/articles/article1.png" alt="توضیح تصویر">
          </div>
            ...
            <h6 class="text-center">10روز پیش</h6>

            <div class="col-12 justify-content-center text-center mt-3">
              <span class="text-center">بازدید : 15 </span>
            </div>
