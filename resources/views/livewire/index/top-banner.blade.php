<div class=" row top_header_banner align-items-center justify-content-center pt-5 mt-5">
    <div class="bg_blur_light pt-2 pb-1 px-4 bg_blur_light rounded_5 d-none d-md-block animate__animated animate__fadeInDown ">
    ...
    <div class="row col-12 col-md-10 justify-content-center article_goup">
        @if (sizeof($categories) > 0)
            ...
            <a href="/search/{{$c->id}}" class="p-4 col-11 col-md-4 animate__animated animate__fadeInDown">
